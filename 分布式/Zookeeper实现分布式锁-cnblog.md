...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195353981-1483619487.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195353749-1032865653.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195353518-750357090.png)

`setnx` 刚执行成功，还未来得及执行 `expire` 指令，节点 1 挂掉了。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195353232-730005720.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195352121-2027261847.png)

如果某些原因导致线程 A 执行的很慢很慢，过了 30 秒都没执行完，这时候锁过期自动释放，线程 B 得到了锁。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195352586-1527671281.png)

随后，线程 A 执行完了任务，线程 A 接着执行 `del` 指令来释放锁。但这时候线程 B 还没执行完，线程A实际上 `删除的是线程 B 加的锁`。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195352344-347792937.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195351925-1768795101.png)

当线程 A 执行完任务，会显式关掉守护线程。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195351723-551997602.png)

另一种情况，如果节点 1 忽然断电，由于线程 A 和守护线程在同一个进程，守护线程也会停下。这把锁到了超时的时候，没人给它续命，也就自动释放了。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195351526-1369796716.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195351312-394431472.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195351117-1209150242.png)

#### 临时节点（EPHEMERAL）

和持久节点相反，当创建节点的客户端与 Zookeeper 断开连接后，临时节点会被删除：

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195350927-453589024.png)

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195350710-391578680.png)

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195350497-933868065.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195350290-1083219326.png)

之后，Client1 查找 ParentLock 下面所有的临时顺序节点并排序，判断自己所创建的节点 Lock1 是不是顺序最靠前的一个。如果是第一个节点，则成功获得锁。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195350072-1173874971.png)

这时候，如果再有一个客户端 Client2 前来获取锁，则在 ParentLock 下载再创建一个临时顺序节点 Lock2。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195349858-1627279679.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195349635-642108403.png)

这时候，如果又有一个客户端 Client3 前来获取锁，则在 ParentLock 下载再创建一个临时顺序节点 Lock3。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195349332-2008582605.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195349108-1518002211.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195348898-558902251.png)

##### 任务执行过程中，客户端崩溃

获得锁的 Client1 在任务执行过程中，如果崩溃，则会断开与 Zookeeper 服务端的链接。根据临时节点的特性，相关联的节点 Lock1 会随之自动删除。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195348671-389969294.png)
...
![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195348424-1673325816.png)

同理，如果 Client2 也因为任务完成或者节点崩溃而删除了节点 Lock2，那么 Client3 就会接到通知。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195348150-1509558063.png)

最终，Client3 成功得到了锁。

![img](https://img2018.cnblogs.com/blog/1005988/202001/1005988-20200103195347753-1963715351.png)
